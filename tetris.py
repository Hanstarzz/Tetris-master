			...
			if DRAW:
				...
				if self.gameover:
					...
					if self.ai and self.runner:
						...
						self.disp_msg("\n  %s: %s\n  %s: %s\n  %s: %s\n  %s: %s\n  %s: %s\n  %s: %s" % (
							"num_holes", chromosome.euristiche[num_holes],
							"num_blocks_above_holes", chromosome.euristiche[num_blocks_above_holes],
							"num_gaps", chromosome.euristiche[num_gaps],
							"max_height", chromosome.euristiche[max_height],
							"avg_height", chromosome.euristiche[avg_height],
							"num_blocks", chromosome.euristiche[num_blocks],
